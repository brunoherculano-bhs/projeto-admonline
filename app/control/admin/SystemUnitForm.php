...
class SystemUnitForm extends TStandardForm
{
    ...
    function __construct()
    {
        ...
        $unit_ban = new TEntry('unitban');
        $xempgeo = new TEntry('empgeo');
        
        // add the fields
        $this->form->addFields( [new TLabel('Id')], [$id] );
        $this->form->addFields( [new TLabel(_t('Name'))], [$name] );
        $this->form->addFields( [new TLabel('Banco')], [$unit_ban] );
        $this->form->addFields( [new TLabel('Código GEO')], [$xempgeo] );
    ...
    /* public function onSave($param)
    {
        try
        {  
            new TMessage('info','SUCESSSSSSOOOO');
        } catch(Exception $e){
               new TMessage('info','SUCESSSSSSOOOO');
        }
    }*/
